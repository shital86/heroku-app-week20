...
public class CreateBookingCRUDTest extends TestBase {
    ...
    public static String firstname = "Kim"+ TestUtils.getRandomValue();
    public static String lastname = "Marsh"+TestUtils.getRandomValue();
    public static Integer totalprice = 140;
